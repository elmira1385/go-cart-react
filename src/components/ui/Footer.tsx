...
const Footer = () => {
  return (
    <footer className="flex flex-col gap-6 p-10 sm:flex-row sm:justify-between">
      <div className="flex flex-col gap-6">
        <div className="text-4xl font-semibold text-t-slate-700">
          <span className="text-green-600">go</span>cart
          <span className="text-green-600 text-5xl leading-0">.</span>
        </div>
        <p className=" text-sm text-t-slate-600 sm:w-100">
        ...
        <div className="flex items-center gap-3 ">
          <div className="flex items-center justify-center w-10 h-10 bg-slate-100 hover:scale-105 hover:border border-slate-300 transition rounded-full">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
      ...
      <div className="flex flex-wrap justify-between  gap-5 text-sm w-full">
        <div className="flex flex-col gap-2">
          <h3 className="font-medium text-slate-700 ">PRODUCTS</h3>
        ...
        <div className="flex flex-col gap-2">
          <h3 className="font-medium text-t-slate-700">WEBSITE?</h3>
          <ul className="space-y-2.5">
            <li className="flex items-center gap-2">
              <p>Home</p>
            </li>
        ...
        <div className="flex flex-col gap-2">
          <h3 className="font-medium text-t-slate-700 ">CONTACT</h3>
          <ul className="space-y-2.5">
            <li className="flex items-center gap-2">
              <svg
                width="16"
