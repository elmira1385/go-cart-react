...
const TamplateOfProducts = ({product=[]}:Props) => {
        ...
        <div className="flex flex-col ">
          <div className="bg-[#F5F5F5] p-5 sm:p-14 rounded-lg ">
            <img
              ...
              decoding="async"
              data-nimg="1"
              className="w-full aspect-square object-contain group-hover:scale-115 transition duration-300 rounded-lg "
              src={item.images[0]}
            />
          </div>
...
export default TamplateOfProducts;
