...
const Hero = () => {
  return (
    <div className="flex flex-col  justify-center items-center bg-t-green-200 rounded-2xl">
      ...
      <img
        ...
        decoding="async"
        data-nimg="1"
        className="sm:absolute bottom-0 right-0 md:right-10 w-full sm:max-w-sm text-transparent"
        src={hero}
      />
    </div>
  );
